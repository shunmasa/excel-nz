...
module.exports = __webpack_require__("huCl");
...
// EXTERNAL MODULE: ./src/components/DropZone.tsx
var DropZone = __webpack_require__("yuya");
...
// CONCATENATED MODULE: ./src/graphql/mutation/updatePost.js

const UPDATE_POST = external_graphql_tag_default.a`
...
`;
/* harmony default export */ var mutation_updatePost = (UPDATE_POST);
// EXTERNAL MODULE: external "react-toastify"
var external_react_toastify_ = __webpack_require__("oAEb");

// EXTERNAL MODULE: ./src/graphql/query/post.js
var post = __webpack_require__("xO0O");
...
// CONCATENATED MODULE: ./pages/dashboard/[dashboard].tsx
...
const useStyles = Object(styles_["makeStyles"])(theme => Object(styles_["createStyles"])({
  ...
  rootin: {
    ...
    marginLeft: '10%',
    height: "600px",
    backgroundColor: "#fff" // boxShadow: `-7px 6px 39px 0px rgba(0,0,0,0.75)`
...
const DialogForm = ({
  ...
  const [updatePost] = Object(react_hooks_["useMutation"])(mutation_updatePost);
  const {
    data,
    error,
    loading
  } = Object(react_hooks_["useQuery"])(post["a" /* default */], {
    variables: {
      postId: dashboard
    }
  });
  ...
  return __jsx(external_react_["Fragment"], null, loading ? __jsx(Loading["a" /* default */], null) : __jsx(external_formik_["Formik"], {
    initialValues: {
    ...
    onSubmit: async (values, {
      ...
      await updatePost({
        variables: {
          postId: router.query.dashboard,
          postUpdate: _objectSpread({}, values)
        }
      }), external_react_toastify_["toast"].success('体験談がアップデートされました');
      router_default.a.push('/dashboard');
      setSubmitting(false);
    }
  }, ({
...
/* harmony default export */ var _dashboard_ = __webpack_exports__["default"] = (Object(withApolloData["a" /* withApollo */])({
  ssr: true
})(DialogForm));
