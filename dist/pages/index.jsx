...
import { Grid, Typography, useScrollTrigger, Button } from '@material-ui/core';
...
const Home = () => {
    ...
    if (loadingN)
        message = 'Loading...';
    if (errorN)
        message = `Error! ${errorN}`;
    if (dataN && dataN.notices.length <= 0)
        message = 'No Posts';
    ...
    const [headerClassName, setHeaderClassName] = useState(defaultHeaderClassName);
  ...
  <ElevationScroll>
    ...
    {({ refs, goTo, activeElement }) => (<Grid container direction="column" className={classes.mainContainer}>
      ...
      <header className={`${headerClassName} ${isSticky ? "navbar1 navbar-sticky" : "navbar1"}`} ref={element}>
        ...
        <div className="row">
          ...
          <div className="mobile-wrapper" role="button" onClick={() => { setStatus(status === 'open' ? 'close' : 'open'), setIsOpened(!isOpened); }}>
    ...
    <nav>
          <ul style={{ transform: "translateZ(0)" }}>
            {screens.map(({ title, color, index }, i) => (<motion.li animate key={i} className={`title ${index === selected || activeElement === index ? "selected" : " "}`} 
    ...
    onClick={() => { setSelected(activeElement === index && index), goTo(index); }}>
                ...
                {index === selected && (<motion.a layoutId="underline" className="underline" style={{ backgroundColor: color }}/>)}
                  {activeElement === index && (<motion.a layoutId="underline" className="underline" style={{ backgroundColor: color }}/>)}
    ...
    <section className="news">
      ...
      <div className="news_inner">
        <h2><img src="/assets/bell.svg" style={{ width: "30px", height: "35px", paddingRight: "2px" }}></img>お知らせ</h2>
        <div className="news_box">
        {loadingN ? (<Loading />) : (dataN &&
        dataN.notices.map((n) => (<blockquote>
            <dl>
    ...
    <Grid item>
      ...
      <Grid item container direction="row" className={classes.primaryContainer} 
    ...
    <ScrollAnimation duration={5} animateIn='tada' initiallyVisible={true}>
    ...
    <Grid item container className="talktext">
        ...
        <p> &nbsp;正しい留学成功の３つの鍵&nbsp;</p><span><img src="/assets/key.svg" style={{ height: "30px", width: "30px" }}></img></span>
            ...
            <Grid item container justify={matchesMD ? "center" : "center"}>
              ...
              <Grid item container direction="column" md alignItems={matchesMD ? "center" : "center"} className={classes.boxContainer}>
              <Grid item>
                ...
                <ScrollAnimation animateIn='fadeIn' animateOut='fadeOut'>
                  <img src="/assets/earth.svg" alt="choose place for abroad" style={{ maxWidth: matchesMD ? 80 : 100 }}/>
                  </ScrollAnimation>
                </Grid>
...
。（参考)
              ...
              <Grid item container direction="column" md alignItems={matchesMD ? "center" : "center"} className={classes.boxContainer}>
                ...
                <ScrollAnimation animateIn='fadeIn' animateOut='fadeOut' delay={1000}>
                  <img src="/assets/school.svg" alt="choose school" style={{ maxWidth: matchesMD ? 80 : 100, paddingTop: "30px" }}/>
                  </ScrollAnimation>
                </Grid>
...
必要な英語力は、渡航までに、中学生は英検３級レベル、高校生は準２級レベルい以上の英語力があることが望まれます。語学学校留学は、現段階での英語力から、留学を始めることが出来ます。大学、専門学留学におきましては、まずご相談ください。
              ...
              <Grid item container direction="column" md alignItems={matchesMD ? "center" : "center"} justify="center" className={classes.boxContainer2}>
                ...
                <Typography variant="h5">
                  ...
                  <img src="/assets/search.svg" alt="search company" style={{ maxWidth: matchesMD ? 80 : 100, paddingTop: "30px" }}/>
...
務内容に現れない「信頼出来る人」であることをお約束いたします。
    ...
    <Grid container className={classes.desContainer} justify="flex-start" alignItems="center" direction="row">
...
・その他サービス
    ...
    <Grid container className={classes.checkContainer}>
      ...
      <Hidden xsDown>
          ...
          <ScrollAnimation duration={7} animateIn='tada' initiallyVisible={true}>
        ...
        width: matchesXS ? "2.5rem" : "3rem" }} alt="clip"/>
            ...
            <Button variant="contained" className={classes.btn}>
             ...
             <span style={{ marginRight: 3 }}>お問い合わせ</span>
                ...
                <ButtonArrow width={35} height={35} fill="#fff"/>
              </Button> 
              </Link>
              </ScrollAnimation>
             </Hidden>
    ...
    <Grid item>
    <Grid container justify="space-around" className={classes.flowContainer} alignItems={matchesXS ? "center" : "flex-start"} direction="column">
    

    <Grid sm item className={classes.imageContainer}>
    <ScrollAnimation animateIn='bounceInLeft' animateOut='bounceOutRight'>
    <img src="/assets/preparation.jpg" style={{ height: "200px", width: "300px", overflow: "hidden",
        borderRadius: "90%" }} alt="image prepare"/>
     </ScrollAnimation>
    ...
    <StepperFnc />
      ...
      <Grid item container direction="column" className={classes.bannerContainer} justify="center" style={{ backgroundColor: "#2b0aad" }}>  
      </Grid>
