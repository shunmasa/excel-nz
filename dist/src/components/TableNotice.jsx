...
const TableNotice = () => {
    ...
    const { data, error, loading, refetch } = useQuery(GET_NOTICES);
    let message = 'Notices';
    if (loading)
        message = 'Loading...';
    if (error)
    ...
    return (<React.Fragment>
      ...
      <Table size="small">
        ...
        {loading ? (<Typography>お知らせを読み込中です</Typography>) : (data &&
        data.notices.map((n) => (<TableRow key={n._id} data-id={n._id}>
