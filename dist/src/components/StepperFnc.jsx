    ...
    return (<div className={classes.root}>
      ...
      <div>
        {activeStep === steps.length ? (<div>
            <Typography className={classes.instructions}>留学の始まりです<img style={{ marginTop: "10px", width: "28px", height: "28px" }} src={'/assets/party.svg'}></img></Typography>
            <Button onClick={handleReset}>リセット</Button>
          </div>) : (<div style={{ marginLeft: "3em", marginTop: "1em" }}>
