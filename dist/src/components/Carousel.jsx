...
export default function CallToAction() {
    ...
    return (<Grid container alignItems="center" justify={matchesSM ? "center" : "space-between"} className={classes.background} direction={matchesSM ? "column" : "row"}>
      ...
      <Grid item style={{
        ...
        <Grid container direction="column">
          ...
          <ScrollAnimation animateIn='bounceInLeft' animateOut='bounceOutRight'>
            ...
            <ScrollAnimation animateIn='bounceInLeft' animateOut='bounceOutRight' delay={800}>
            <Typography variant="subtitle2" gutterBottom style={{ fontSize: matchesSM ? "1.25rem" : "1.5rem" }}>
              まずは一度お問い合わせください。
            </Typography>
            </ScrollAnimation>
      ...
      　<Link href="/contact">
        <Button variant="contained" className={`${classes.btn} ${classes.contactButton}`}>
         お問い合わせ
        </Button>
        </Link>
        </ScrollAnimation>
