...
export default function About() {
    ...
    return (<Grid container className={classes.mainContainer} direction="column">



    <ScrollAnimation animateIn='bounceInRight' animateOut='bounceOutLeft'>
    <Grid item>
    <Grid container className={classes.secondContainer} justify="space-around" alignItems="flex-start" direction="column">
...
ご気軽にご相談ください。
    ...
    <ScrollAnimation animateIn='bounceInLeft' animateOut='bounceOutRight' delay={400}>
